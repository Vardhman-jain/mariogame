...
function changeGameStatud(character){
  if(gameStatus=="start" && noseX != "" && gameConfig.status==="start") {//keyDown is a function to see if a key if pressed and || means or and && means and; and we need to satisfy both the comditions and === means
    world_start.play();
